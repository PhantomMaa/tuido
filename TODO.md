...
## Todo
- 增加 'e' 按键操作的支持，在 tui 下修改任务 ~2026-03-06T10:07
- 增加 `tuido add` 命令，新增任务 ~2026-03-06T10:07
- 增加 `tuido pick` 命令，在 TODO 里挑选最顶端的任务返回，并移动至下个栏目 ~2026-03-06T10:09
- 修复 `--global-view --push` 时，对 project 解析的问题，导致的比对错误 #bugfix ~2026-03-05T17:12
- `tuido` 命令打开全部项目，`tuido .` 打开当前项目 !P2 ~2026-03-06T10:19
